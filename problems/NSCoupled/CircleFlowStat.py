...
def theend_hook(mesh, q_, p_, u_,u_components, nu, VQ, V, VV,Q, U, d, \
				sys_comp, up_, key, plotit, CFLwrite, resultswrite, **NS_namespace):
	...
	if plotit == True:
		...
		if os.path.isnotdir("/home/guttorm/Desktop/Master/Oasis/results/data/ResultsRe20%s" % atm):
			os.system("mkdir -p /home/guttorm/Desktop/Master/Oasis/results/data/ResultsRe20%s" % atm)
		f = File("/home/guttorm/Desktop/Master/Oasis/results/data/ResultsRe20%s/u_from_CircleStat_key%d.pvd" % (atm,key))
		f << uu
